...
class _HomePageState extends State<HomePage> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Consumer(builder: (context, watch, child) {
          ...
          //Bu fonksiyon yazılan kategorideki ürünleri getiriyor 
          
          final homeProvider = watch(getAllProductProvider("110"));
          //Sepete eklenen ürünleri getiriyor
  ...
  Column buildColumn(
    ...
    return Column(
      children: [
        // Slider ile resimleri gösteriyor
        SliderSection(),
        Text("Our Tastes",
            style: TextStyle(
          ...
          return InkWell(
            ...
            child: MyProduct(
                onpressed: IconButton(
                  icon: cart.isExist == false ?Icon(Icons.add_shopping_cart_outlined) : Icon(Icons.done),
                  onPressed: () {
