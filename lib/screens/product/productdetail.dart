...
class _ProductDetailState extends State<ProductDetail> {
    ...
    return Scaffold(
      key: _scfKey,
        appBar: AppBar(
          ...
          elevation: 0,
          actions: [
            // Anasayfaya dönüş için kullanılabilir
            IconButton(
              color: Colors.green,
  ...
  Container buildProductPrice(BuildContext context) {
    return Container(
  ...
  Container buildProductImage(BuildContext context) {
    return Container(
  ...
  Container buildProductName(BuildContext context) {
    return Container(
            padding: EdgeInsets.all(10),
            child: Padding(
